...
for handwriting recognition and generation~\ref{graves}
could also be used to generate children-like handwriting. 

The second question focus on the leanring algorithm. In
~\cite{Hood}, we were projecting children's demonstrations in PCA's sigenspace in order to 
...
demonstrations shows that CoWriter is not only a simple game of interaction with
a robot, but can have a positive therapeutic impact.
